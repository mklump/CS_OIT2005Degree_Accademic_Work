// Fig. 6.58 MaximumValueEditor.java
// MaximumValueEditor is the PropertyEditor for the 
// maximumValue property of the SliderFieldPanel bean.
package com.deitel.advjhtp1.beans;

// Java core packages
import java.beans.*;

public class MaximumValueEditor extends PropertyEditorSupport {
   ...
   public void setAsText( String string )
   {
      ...
      try {
         maximumValue = Integer.decode( string );
         firePropertyChange();
      }
   ...
   // get String array for pull-down menu
   ...
   // get maximumValue property as string
