...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cmSummarizeOrders As System.Data.SqlClient.SqlCommand
    Friend WithEvents cmGetOrderSummary As System.Data.SqlClient.SqlCommand
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmSummarizeOrders = New System.Data.SqlClient.SqlCommand()
        Me.cmGetOrderSummary = New System.Data.SqlClient.SqlCommand()
        ...
        'cmSummarizeOrders
        '
        Me.cmSummarizeOrders.CommandText = "dbo.SummarizeOrders"
        Me.cmSummarizeOrders.CommandType = System.Data.CommandType.StoredProcedure
        Me.cmSummarizeOrders.Connection = Me.cnNorthwind
        Me.cmSummarizeOrders.Parameters.Add(New System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, True, CType(10, Byte), CType(0, Byte), "", System.Data.DataRowVersion.Current, Nothing))
        '
        'cmGetOrderSummary
        '
        Me.cmGetOrderSummary.CommandText = "dbo.GetOrderSummary"
        Me.cmGetOrderSummary.CommandType = System.Data.CommandType.StoredProcedure
        Me.cmGetOrderSummary.Connection = Me.cnNorthwind
        Me.cmGetOrderSummary.Parameters.Add(New System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, True, CType(10, Byte), CType(0, Byte), "", System.Data.DataRowVersion.Current, Nothing))
        '
        'frmConnectedApp
        '
...
#End Region
    ...
    Private Sub btnSummarizeOrders_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSummarizeOrders.Click
        ...
        While drProducts.Read()
            ...
            Dim orders As Int32 = drProducts.GetInt32(0)
            Dim name As String = drProducts.GetString(1)

            ' Display details in the lstOrderSummary list box
            lstOrderSummary.Items.Add(orders & vbTab & name)
        End While
