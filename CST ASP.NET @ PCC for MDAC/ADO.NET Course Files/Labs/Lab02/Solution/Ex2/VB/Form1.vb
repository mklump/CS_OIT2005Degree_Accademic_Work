    ...
    Private Sub btnOpenSQL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenSQL.Click
        ...
        Try
            ...
            Me.cnSQLNorthwind.ConnectionString = _
                ...
                Me.chkIntegratedSecurity.Checked.ToString() & ";" & _
        ...
        Catch XcpSQL As System.Data.SqlClient.SqlException
            ...
            For Each se In XcpSQL.Errors
                ...
                MessageBox.Show(sErrorMsg, "SQL Server Error " & _
                    se.Number, MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        Catch XcpInvOp As System.InvalidOperationException
            ...
            MessageBox.Show("Close the connection first!", "Invalid Operation", _
        ...
        Finally ' in every case, display connection string

            MessageBox.Show(cnSQLNorthwind.ConnectionString, "ConnectionString", _
