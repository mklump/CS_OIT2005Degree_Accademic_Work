...
namespace ConnectingToDataSources
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Data.OleDb.OleDbConnection cnOleDbNorthwind;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.cnOleDbNorthwind = new System.Data.OleDb.OleDbConnection();
		...
		private void btnOpenOleDb_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				this.cnOleDbNorthwind.ConnectionString = 
					"Provider=" + this.txtProvider.Text + ";" +
					"Data Source=" + this.txtOleDbDatabase.Text + ";";

				// Open the connection

				this.cnOleDbNorthwind.Open();
			}
		...
		private void btnCloseOleDb_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				this.cnOleDbNorthwind.Close();

				// Call Dispose method to release resources used by object

				this.cnOleDbNorthwind.Dispose();
		...
		private void cnOleDbNorthwind_StateChange(object sender, System.Data.StateChangeEventArgs e)
		{
		...
		{
			// add an event handler for the StateChange event

			this.cnOleDbNorthwind.StateChange += new System.Data.StateChangeEventHandler(this.cnOleDbNorthwind_StateChange);
		}
