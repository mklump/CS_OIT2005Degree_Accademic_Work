...
#Region " Web Services Designer Generated Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'cmSelectEmployees
        '
        Me.cmSelectEmployees.CommandText = "SELECT EmployeeID, LastName + ', ' + FirstName AS FullName FROM EmployeesLatestOR" & _
        "DER BY LastName, FirstName"
        Me.cmSelectEmployees.Connection = Me.cnNorthwindInstructor
        '
        'cnNorthwindInstructor
        '
        Me.cnNorthwindInstructor.ConnectionString = "data source=London;initial catalog=Northwind;user id=MaryJoe;password=secret;pers" & _
        ...
        Me.cmInsertCustomers.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CustomerID", System.Data.SqlDbType.Int, 4, "CustomerID"))
        ...
        Me.cmInsertCustomers.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ContactName", System.Data.SqlDbType.NVarChar, 30, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "ContactName", System.Data.DataRowVersion.Current, Nothing))
        Me.cmInsertCustomers.Parameters.Add(New System.Data.SqlClient.SqlParameter("@City", System.Data.SqlDbType.NVarChar, 15, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "City", System.Data.DataRowVersion.Current, Nothing))
        Me.cmInsertCustomers.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Phone", System.Data.SqlDbType.NVarChar, 24, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "Phone", System.Data.DataRowVersion.Current, Nothing))
        '
        'cmSelectCustomers
        '
        Me.cmSelectCustomers.CommandText = "SelectClients"
        ...
        Me.cmSelectCustomers.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EmployeeID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "EmployeeID", System.Data.DataRowVersion.Current, Nothing))
        '
        'cmUpdateCustomers
        '
        ...
        Me.cmUpdateOrderDetails.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Quantity", System.Data.SqlDbType.Int, 2, "Quantity"))
        ...
        Me.cmUpdateOrderDetails.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Quantity", System.Data.SqlDbType.Int, 2, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "Quantity", System.Data.DataRowVersion.Original, Nothing))
        ...
        Me.cmInsertOrderDetails.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Quantity", System.Data.SqlDbType.Int, 2, "Quantity"))
        '
        'cmSelectOrders
        '
        ...
        Me.cmSelectOrders.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EmployeeID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "EmployeeID", System.Data.DataRowVersion.Current, Nothing))
        '
        'daOrders
        '
        ...
        Me.cmInsertOrders.Parameters.Add(New System.Data.SqlClient.SqlParameter("@OrderDate", System.Data.SqlDbType.DateTime, 8, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "OrderDate", System.Data.DataRowVersion.Current, Nothing))
        Me.cmInsertOrders.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EmployeeID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "EmployeeID", System.Data.DataRowVersion.Current, Nothing))
        Me.cmInsertOrders.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CustomerID", System.Data.SqlDbType.NChar, 5, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "CustomerID", System.Data.DataRowVersion.Current, Nothing))
        '
        'cmUpdateOrders
        '
        ...
        Me.cmSelectOrderDetails.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EmployeeID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, True, CType(0, Byte), CType(0, Byte), "EmployeeID", System.Data.DataRowVersion.Current, Nothing))
        '
        'daOrderDetails
        '
...
#End Region
    ...
    <WebMethod()> Public Function GetDataSet(ByVal iEmployeeID As System.Int32, ByVal sServerName As System.String) As OnTheRoadWS.NWDataSet
        ...
        Dim EmployeeID As System.Int32
        ...
        Me.tempNW.Fill(daEmployees.Employees)
        ...
        Me.daOrderDetails.SelectCommand.Parameters("@EmployeeID").Value = EmployeeID
    ...
    <WebMethod()> Public Sub UpdateDatabase(ByVal dsNorthwind As OnTheRoadWS.NWDataSet)
        ...
        Me.cnNorthwind.ConnectionString = _
         "data source=" & dsNorthwind.AppSettings.Rows(0)("ServerName").ToString() & ";" & _
         "initial catalog=Northwind;" & _
         "integrated security=SSPI;" & _
         "persist security info=False;"
