...
Public Class NWDataSet
    ...
    Public Class OrderDetailsDataTable
        ...
        Public Overloads Function AddOrderDetailsRow(ByVal OrderID As Integer, ByVal parentProductsRowByProductsOrderDetails As ProductsRow, ByVal UnitPrice As Decimal, ByVal Quantity As Short) As OrderDetailsRow
            Dim rowOrderDetailsRow As OrderDetailsRow = CType(Me.NewRow,OrderDetailsRow)
            rowOrderDetailsRow.ItemArray = New Object() {OrderID, parentProductsRowByProductsOrderDetails(0), UnitPrice, Quantity}
