...
namespace OnTheRoad.localhost {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="SalesManagerSoap", Namespace="http://tempuri.org/")]
    public class SalesManager : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        /// <remarks/>
        public SalesManager() {
            this.Url = "http://localhost/2389/Labs/Lab07/Solution/CS/OnTheRoadWS/SalesManager.asmx";
        }
        ...
        public NWDataSet GetDataSet(int iEmployeeID, string sServerName) {
            object[] results = this.Invoke("GetDataSet", new object[] {
                        iEmployeeID,
                        sServerName});
            return ((NWDataSet)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginGetDataSet(int iEmployeeID, string sServerName, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public NWDataSet EndGetDataSet(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((NWDataSet)(results[0]));
        }
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/UpdateDatabase", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void UpdateDatabase(NWDataSet dsNorthwind) {
            this.Invoke("UpdateDatabase", new object[] {
                        dsNorthwind});
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginUpdateDatabase(NWDataSet dsNorthwind, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("UpdateDatabase", new object[] {
                        dsNorthwind}, callback, asyncState);
        }
    ...
    public class NWDataSet : DataSet {
        ...
        private DataRelation relationOrdersOrderDetails;
        ...
        private void InitClass() {
            ...
            fkc = new ForeignKeyConstraint("OrdersOrderDetails", new DataColumn[] {
            ...
            this.relationOrdersOrderDetails = new DataRelation("OrdersOrderDetails", new DataColumn[] {
                        this.tableOrders.OrderIDColumn}, new DataColumn[] {
        ...
        public class OrderDetailsDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public OrderDetailsRow AddOrderDetailsRow(OrdersRow parentOrdersRowByOrdersOrderDetails, ProductsRow parentProductsRowByProductsOrderDetails, System.Decimal UnitPrice, short Quantity) {
                OrderDetailsRow rowOrderDetailsRow = ((OrderDetailsRow)(this.NewRow()));
                rowOrderDetailsRow.ItemArray = new object[] {
                        parentOrdersRowByOrdersOrderDetails[0],
        ...
        public class OrdersRow : DataRow {
            ...
            public OrderDetailsRow[] GetOrderDetailsRows() {
                return ((OrderDetailsRow[])(this.GetChildRows(this.Table.ChildRelations["OrdersOrderDetails"])));
            }
        }
