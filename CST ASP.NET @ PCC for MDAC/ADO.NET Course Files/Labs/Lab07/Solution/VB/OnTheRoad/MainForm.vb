...
#End Region
    ...
    Private Sub mnuFill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuFill.Click
        ...
        Catch Xcp As System.Exception
            ...
            MessageBox.Show("Failed to connect because:" & vbCrLf & Xcp.ToString() & vbCrLf & vbCrLf & "Try a different web service name.", "Get from central database", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
    ...
    Private Sub RefreshUI()
        ...
        Me.grd.SetDataBinding(Me.dsNorthwind, "Customers")
