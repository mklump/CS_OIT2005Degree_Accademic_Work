...
Public Class NWDataSet
    ...
    Public Class CustomersDataTable
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New UniqueConstraint("PK_Customers", New DataColumn() {Me.columnCustomerID}, false))
    ...
    Public Class EmployeesDataTable
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New UniqueConstraint("PK_Employees", New DataColumn() {Me.columnEmployeeID}, true))
    ...
    Public Class OrderDetailsDataTable
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New UniqueConstraint("PK_OrderDetails", New DataColumn() {Me.columnOrderID, Me.columnProductID}, false))
