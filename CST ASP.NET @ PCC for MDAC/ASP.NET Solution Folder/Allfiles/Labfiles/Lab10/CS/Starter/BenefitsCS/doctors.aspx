...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:DataGrid id=dgDoctors style="Z-INDEX: 106; LEFT: 144px; POSITION: absolute; TOP: 168px" runat="server" DataSource="<%# dsDoctors1 %>" DataMember="doctors" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" BackColor="White" CellPadding="3" GridLines="Vertical" ForeColor="Black" PageSize="5" AllowPaging="True">
