...
#Region " Web Form Designer Generated Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'SqlConnection1
        '
        Me.SqlConnection1.ConnectionString = "data source=localhost;initial catalog=doctors;integrated security=SSPI;persist se" & _
        "curity info=True"
        '
        'SqlInsertCommand1
        '
        ...
        Me.DsDoctors1.Locale = New System.Globalization.CultureInfo("en-US")
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If (Cache("doctors") Is Nothing) Then
            ...
            Cache.Insert("doctors", DsDoctors1, Nothing, DateTime.Now.AddMinutes(4), Nothing)
        End If
    ...
    Private Sub lstCities_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstCities.SelectedIndexChanged
        ...
        If strCity = "[All]" Then
            dgDoctors.DataSource = Cache("doctors")
        Else
            Dim dvDocs As New DataView(CType(Cache("doctors"), DataSet).Tables(0))
            dvDocs.RowFilter = "city = '" & strCity & "'"
            dgDoctors.DataSource = dvDocs
        End If
        reset()
