...
namespace DentalServiceCS {
    ...
    public class dsDentists : DataSet {
        ...
        protected dsDentists(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsDentists cln = ((dsDentists)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsDentists";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsDentists.xsd";
