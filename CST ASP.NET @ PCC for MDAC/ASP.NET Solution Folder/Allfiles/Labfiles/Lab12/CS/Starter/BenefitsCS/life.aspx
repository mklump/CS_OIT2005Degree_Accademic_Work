...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:RequiredFieldValidator id="vldName" style="Z-INDEX: 122; LEFT: 295px; POSITION: absolute; TOP: 171px" runat="server" Height="20px" ErrorMessage="Name cannot be blank" ControlToValidate="txtName">*</asp:RequiredFieldValidator>
