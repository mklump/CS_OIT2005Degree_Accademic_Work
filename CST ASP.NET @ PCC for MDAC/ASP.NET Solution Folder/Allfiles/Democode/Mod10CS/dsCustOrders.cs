...
namespace Mod10CS {
    ...
    public class dsCustOrders : DataSet {
        
        private CustomersDataTable tableCustomers;
        
        private OrdersDataTable tableOrders;
        
        private DataRelation relationCustOrders;
        ...
        protected dsCustOrders(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsCustOrders cln = ((dsCustOrders)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsCustOrders";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsCustOrders.xsd";
            ...
            fkc = new ForeignKeyConstraint("CustOrders", new DataColumn[] {
            ...
            this.relationCustOrders = new DataRelation("CustOrders", new DataColumn[] {
                        this.tableCustomers.CustomerIDColumn}, new DataColumn[] {
        ...
        public class CustomersRow : DataRow {
            ...
            public OrdersRow[] GetOrdersRows() {
                return ((OrdersRow[])(this.GetChildRows(this.Table.ChildRelations["CustOrders"])));
            }
        }
        ...
        public class OrdersDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public OrdersRow AddOrdersRow(CustomersRow parentCustomersRowByCustOrders, int EmployeeID, System.DateTime OrderDate, System.DateTime RequiredDate, System.DateTime ShippedDate, int ShipVia, System.Decimal Freight, string ShipName, string ShipAddress, string ShipCity, string ShipRegion, string ShipPostalCode, string ShipCountry) {
