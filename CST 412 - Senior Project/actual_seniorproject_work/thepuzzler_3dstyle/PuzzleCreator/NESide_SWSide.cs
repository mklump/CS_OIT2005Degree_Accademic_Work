...
// SubModule: "North East Side to South West Side"
...
namespace Puzzle_Creation
{
	...
	/// </summary>
	public sealed class NESide_SWSide : PuzzleCreator
	{
		/// <summary>
		...
		{
			int insertLength;
			for( insertLength = 0; posx > -1; posx-- )
			{
...
//					Trace.Write( puzzle[posx,posy,posz].ToString() );
		...
		{
			for( int nextChar = 0; posx > -1 && nextChar < word.Length; posx-- )
			{
				if( puzzle[posx,posy,posz] == ' ' )
