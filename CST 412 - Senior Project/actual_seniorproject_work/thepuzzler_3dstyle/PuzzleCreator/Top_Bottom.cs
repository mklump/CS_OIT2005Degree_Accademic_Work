...
// SubModule: "Top Puzzle Side to Bottom Puzzle Side"
...
namespace Puzzle_Creation
{
	...
	/// </summary>
	public sealed class Top_Bottom : PuzzleCreator
	{
		/// <summary>
		...
		{
			int insertLength;
			for( insertLength = 0; posy > -1; posy-- )
			{
...
//					Trace.Write( puzzle[posx,posy,posz].ToString() );
		...
		{
			for( int nextChar = 0; posy > -1 && nextChar < word.Length; posy-- )
			{
				if( puzzle[posx,posy,posz] == ' ' )
