...
// SubModule: "Corner to Coner, Top West to the Lower East"
...
namespace Puzzle_Creation
{
	...
	/// </summary>
	public sealed class CCTW_LE : PuzzleCreator
	{
		/// <summary>
...
//					Trace.Write( puzzle[posx,posy,posz].ToString() );
		...
		{
			for( int nextChar = 0;
				posx < xBoundary && posy > -1 && posz > -1 && nextChar < word.Length;
				++posx, --posy, --posz )
			{
				if( puzzle[posx,posy,posz] == ' ' )
