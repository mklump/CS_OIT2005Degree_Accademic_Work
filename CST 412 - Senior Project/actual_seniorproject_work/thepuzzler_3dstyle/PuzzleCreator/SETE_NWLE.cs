...
// SubModule: "South East Top Edge to North West Lower Edge"
...
namespace Puzzle_Creation
{
	...
	/// </summary>
	public sealed class SETE_NWLE : PuzzleCreator
	{
		/// <summary>
...
//					Trace.Write( puzzle[posx,posy,posz].ToString() );
		...
		{
			for( int nextChar = 0;
				posz < zBoundary && posy > -1 && nextChar < word.Length;
				++posz, --posy )
			{
				if( puzzle[posx,posy,posz] == ' ' )
