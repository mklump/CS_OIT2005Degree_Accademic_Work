...
implement aboutDialog
    ...
    constants
        controlList : vpiDomains::windef_list =
            ...
            ctl(wdef(wc_Text,rct(12,56,132,66),"Copyright (c)",u_DlgBase),idc_dlg_about_st_copy,[wsf_AlignLeft]),
            ctl(wdef(wc_Text,rct(12,66,132,76),"",u_DlgBase),idc_dlg_about_st_firm,[wsf_AlignLeft]),
            icon(wdef(wc_Icon,rct(12,6,28,22),"",u_DlgBase),idc_aboutdialog_1,application_icon,[]),
