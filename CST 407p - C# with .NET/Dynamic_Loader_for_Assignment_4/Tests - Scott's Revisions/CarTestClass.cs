...
namespace testHarness_Car
{
	...
	{
		protected bool []  testFlags;// Test flags for various object states
		protected Car      m_car;    // Gemeric base class object
		protected object   ob;		// Typeless object for testing
		//public static StreamWriter Trace;	// For testing output
		...
		public CarTestClass()
		{
			...
			//Trace = new StreamWriter( "output.txt", false );
		}
		[SetUp]
