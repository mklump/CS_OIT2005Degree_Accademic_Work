...
void main (void)
{
	...
	Card deck[DECK_SIZE];  // LAB TASK Change the deck to a linked list of cards
    char play_continues;
    
    SPlayer player1("Nostro",'w');
    SPlayer player2("Ralph",' ');
    ...
    do 
    {
	    ...
	    ShuffleIfNeeded(deck, DECK_SIZE,SHUFFLE_AT); 
